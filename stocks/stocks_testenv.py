...
class StockTestEnv(gym.Env):
    ...
    def __init__(self, day = 0, money = INITIAL_BALANCE , scope = 1):
        ...
        temp[self.day+1,1:stock_num+2] = test_data.iloc[self.day, 1:stock_num+2]
    ...
    def step(self, action):
        # print(self.day)
        self.terminal = self.day >= test_length - 1
        # print(actions)
        ...
        if self.terminal:
            ...
            self.day += 1
            self.state[self.day+1, 1:stock_num+2] = test_data.iloc[self.day, 1:stock_num+2] 
