...
register(id='stocks-v0', 
    entry_point='gym.envs.stocks:StockEnv', 
)

register(id='stocksval-v0', 
    entry_point='gym.envs.stocks:StockValEnv', 
)

register(id='stockstest-v0', 
    entry_point='gym.envs.stocks:StockTestEnv', 
)
